...
import static org.folio.rest.jaxrs.resource.UsersSettings.PutUsersSettingsByIdResponse.respond400WithTextPlain;
import static org.folio.rest.jaxrs.resource.UsersSettings.PutUsersSettingsByIdResponse.respond500WithTextPlain;
...
public class UsersSettingsService {
  ...
  private Future<Response> updateEntity(Conn conn, String id, Setting prevValue, Setting newValue) {
    ...
    return conn.update(TABLE_NAME_SETTINGS, newValue, id)
      ...
      .map(rows -> UsersSettings.PutUsersSettingsByIdResponse.respond204());
  }
