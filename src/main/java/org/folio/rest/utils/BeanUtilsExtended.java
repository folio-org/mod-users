...
public class BeanUtilsExtended extends org.springframework.beans.BeanUtils {
    ...
    private static void copyPropertiesNotNull(Object source, Object target, Class<?> editable,
            ...
            if (sourceReadMethod != null &&
              ...
              try {
                ...
                if (sourceValue != null && targetReadMethod != null) {
                  ...
                  } else if (targetValue instanceof Collection<?> && ((Collection<?>) targetValue).isEmpty()) {
