...
class VertxOkapiHttpClientTest {
  ...
  @SneakyThrows
  @Test
  void canDeleteWithJson() {
    final var deleteEndpoint = matchingFolioHeaders(delete(urlPathEqualTo("/record")));

    fakeWebServer.stubFor(deleteEndpoint.willReturn(noContent()));
    ...
    assertThat(countOfRequestsMadeTo(deleteEndpoint), is(1));
  }
