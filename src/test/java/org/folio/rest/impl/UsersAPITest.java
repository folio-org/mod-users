...
//    new UsersAPI(folioS3Client).getUsers(null, null, null, 0, 0, null, null, null,
...
//    new UsersAPI(folioS3Client).postUsers(null, null, null, null,
//        vtc.succeeding(response -> vtc.verify( () -> {
//          assertThat(response.getStatus(), is(500));
//          vtc.completeNow();
//        })), null);
...
//
//    new UsersAPI(folioS3Client).postUsers(null, user, null, okapiHeaders,
//      vtc.succeeding(response -> vtc.verify( () -> {
...
//
//    new UsersAPI(folioS3Client).postUsersProfilePicture(null, okapiHeaders,
//      vtc.succeeding(response -> vtc.verify( () -> {
//        assertThat(response.getStatus(), is(500));
...
//    new UsersAPI(folioS3Client).postUsersProfilePicture(emptyInputStream, okapiHeaders,
//      vtc.succeeding(response -> vtc.verify( () -> {
//        assertThat(response.getStatus(), is(500));
...
//    new UsersAPI(folioS3Client).postUsersProfilePicture(inputStream, okapiHeaders,
//      vtc.succeeding(response -> vtc.verify( () -> {
//        assertThat(response.getStatus(), is(500));
...
//    new UsersAPI(folioS3Client).postUsers(null, new User(), null, null,
//        vtc.succeeding(response -> vtc.verify( () -> {
//          assertThat(response.getStatus(), is(500));
//          vtc.completeNow();
//        })), null);
...
//      }
//    };
//    new UsersAPI(folioS3Client).postUsers(null, new User(), null, okapiHeaders,
//        vtc.succeeding(response -> vtc.verify( () -> {
//          assertThat(response.getStatus(), is(500));
//          vtc.completeNow();
//        })), null);
...
//    new UsersAPI(folioS3Client).putUsersByUserId(null, null, null, null,
//        vtc.succeeding(response -> vtc.verify( () -> {
//          assertThat(response.getStatus(), is(500));
//          vtc.completeNow();
//        })), null);
...
//    final var future = new UsersAPI(folioS3Client)
...
//    Future<Boolean> future = new UsersAPI(folioS3Client).checkAllAddressTypesValid(user, null);
//    future.onComplete(context.failing(e -> context.verify(() -> {
//      assertThat(future.cause(), is(instanceOf(NullPointerException.class)));
//      context.completeNow();
//    })));
